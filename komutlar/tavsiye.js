...
let channel = bot.channels.get("697845400324800618")//tavsiye kanal id
...
message.channel.send(":white_check_mark:  **| tavsiye Başarı İle İletildi.**")
...
exports.help = {
  name: 'tavsiye',
  description: 'yapımcıya tavisyede bulunursunuz.',
  usage: 'tavsiye'
}